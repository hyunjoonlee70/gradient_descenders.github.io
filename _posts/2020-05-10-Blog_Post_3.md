---
layout: post
title: Midway Post - Finetuning GPT-2 for keyword based controlled text generation.
---
...
In Initial Blog Post (1), we talked about Conditional Transformer Language Model (CTRL) and Plug and Play Language Model (PPLM). However, we decided to build our initial model on a language model called GPT-2 and incorporate CCTL and PPLM into GPT-2 as our final model.
